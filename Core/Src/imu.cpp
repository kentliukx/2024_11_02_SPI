...
uint8_t tx_data[3],rx_data[14];
int16_t accel_ratio[4]={2,4,8,16}, gyro_ratio[4]={250,500,1000,2000};
int16_t x_temp,y_temp,z_temp;

const uint8_t accel_sel=3,gyro_sel=3;
